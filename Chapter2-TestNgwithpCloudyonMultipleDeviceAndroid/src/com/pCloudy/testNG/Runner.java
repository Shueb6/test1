...
public class Runner {
	...
	public void prepareTest(String deviceName) throws IOException, InterruptedException {
		...
		capabilities.setCapability("pCloudy_Username", "shueb.ahmed@sstsinc.com");
		capabilities.setCapability("pCloudy_ApiKey", "xshjztx36tj34d47xg4xv4cy");
		...
		capabilities.setCapability("project", "Demo");
		capabilities.setCapability("build", "Test");
		capabilities.setCapability("name", "Sanity");
		capabilities.setCapability("tag", "Automation");
		driver = new AndroidDriver(new URL("https://device.pcloudy.com/progressive/wd/hub"), capabilities);
		System.out.println("DriverInitialized");
		
		//https://device.pcloudy.com/appiumcloud/wd/hub
		//https://device.pcloudy.com/progressive/wd/hub
		//https://us.pcloudy.com/progressive/wd/hub
	}
